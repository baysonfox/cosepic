...
interface CheckboxProps extends CheckboxPrimitive.Root.Props {
  /**
   * Custom indicator content. Defaults to a CheckIcon. Useful when the
   * caller wants to render a minus glyph for the indeterminate state.
   */
  indicator?: ReactNode
}

function Checkbox({ className, indicator, ...props }: CheckboxProps) {
  return (
